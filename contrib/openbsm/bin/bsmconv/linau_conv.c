    ...
    size_t desiredfieldscount, ...)
{
	...
	PJDLOG_ASSERT(record != NULL);
	/*
	 * XXX If there are no fields to check why do you even call this
	 * function?
	 */
	...
	for (ii = 0; ii < desiredfieldscount; ii++) {
		...
		/*
		 * XXX For the time being it is illegal to require an undefined
		 * field.
		 */
		PJDLOG_VERIFY(fieldnameid != LINAU_FIELD_NAME_UNDEFINED);
