...
int linau_event_compare_origin(const struct linau_event *event,
...
nvlist_t *linau_record_get_fields(const struct linau_record *record);
uint32_t linau_record_get_id(const struct linau_record *record);
size_t linau_record_get_size(const struct linau_record *record);
uint64_t linau_record_get_time(const struct linau_record *record);
const char *linau_record_get_type(const struct linau_record *record);

void linau_record_move_fields(struct linau_record *record, nvlist_t *fields);
void linau_record_set_id(struct linau_record *record, uint32_t id);
void linau_record_set_time(struct linau_record *record, uint64_t time);
void linau_record_move_type(struct linau_record *record, char *type);
...
int linau_record_comapre_origin(const struct linau_record *reca,
...
void linau_field_move_name(struct linau_field *field, char *name);
void linau_field_move_value(struct linau_field *field, char *value);
